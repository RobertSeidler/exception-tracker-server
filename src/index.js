...
console.log(path.join(__dirname.split('/').slice(0, -1).join('/'), staticFolder.substr(1)))

app.use(
  staticFolder, 
  express.static(path.join(__dirname.split('/').slice(0, -1).join('/'), staticFolder.substr(1)))
);
